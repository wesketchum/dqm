/**
 * @file DQMProcessorBase.hpp DQMProcessorBase Class Interface
 *
 * DQMProcessorBase is a virtual base class that illustrates how to make a DUNE DAQ
 ...
 */
#ifndef DQM_PLUGINS_DQMPROCESSORBASE_HPP_
#define DQM_PLUGINS_DQMPROCESSORBASE_HPP_
...
public:
   ...
   */
  explicit DQMProcessorBase(const std::string& name);

  DQMProcessorBase(const DQMProcessorBase&) = delete;            ///< DQMProcessor is not copy-constructible
  DQMProcessorBase& operator=(const DQMProcessorBase&) = delete; ///< DQMProcessor is not copy-assignable
  DQMProcessorBase(DQMProcessorBase&&) = delete;                 ///< DQMProcessor is not move-constructible
  DQMProcessorBase& operator=(DQMProcessorBase&&) = delete;      ///< DQMProcessor is not move-assignable
